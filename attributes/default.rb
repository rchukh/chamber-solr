default['chamber']['solr']['version']          	= '4.10.0'
default['chamber']['solr']['url']              	= ::File.join(
                                                              node['ark']['apache_mirror'],
                                                              'lucene/solr',
                                                              node['chamber']['solr']['version'],
                                                              "solr-#{node['chamber']['solr']['version']}.tgz"
                                                              )
default['chamber']['solr']['archive_war_path'] 	= ::File.join(
                                                              "solr-#{node['chamber']['solr']['version']}",
                                                              'dist',
